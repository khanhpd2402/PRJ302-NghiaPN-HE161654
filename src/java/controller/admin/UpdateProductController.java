    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (fileName.trim() == null || fileName.trim().length() == 0) {
                ...
                String savePath = "C:\\Users\\ACER\\OneDrive\\Máy tính\\PRJNghiaPN\\web\\images"; // Giả sử có một thư mục images trên máy cua minh
            ...
            Product p = new Product(productId, ProductName, describe, originPrice, salePrice, discount, img, quantity + 100, productStatus, brandId, categoryId, cpu, ram, capacity, graphic, display);
            pd.updateProduct(p);
            response.sendRedirect("productmanage");
